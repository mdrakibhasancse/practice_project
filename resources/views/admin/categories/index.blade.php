    ...
    <div class="card-header">
        ...
        <div class="card-tools">
          <div class="input-group input-group-sm" style="width: 150px;">
            <input type="text" name="table_search" class="form-control float-right category-search" data-url="{{ route('admin.categories.search') }}" placeholder="Search">
     ...
     <div class="card-body">
        <div class="table-responsive table-responsive-sm data-container">
            @includeIf('admin.categories.searchData')
        </div>
